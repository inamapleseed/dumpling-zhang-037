...
$_['subject_admin.order.status'] = '{store_name} - Order Update {order_id}';
$_['text_update_status2'] = 'Order <b>#{order_id}</b> has been updated to the following status: <b>{order_status}</b>';
