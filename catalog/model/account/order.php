<?php
	class ModelAccountOrder extends Model {
		...
		public function getOrderProductById($product_id) {

			$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_product op
				LEFT JOIN ".DB_PREFIX."order o ON op.order_id = o.order_id
				WHERE 
					op.product_id = '" . (int)$product_id . "' AND
	...
	public function getShippingDetail($order_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "lalamove` WHERE lalamove_order_id = '" . (int)$order_id . "'");
