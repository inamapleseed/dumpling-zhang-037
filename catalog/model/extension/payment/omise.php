...
class ModelExtensionPaymentOmise extends Model {
    ...
    public function retrieveOmiseKeys() {
        if ( ( $this->config->get('omise_paynow_status') || $this->config->get('omise_status') ) && $this->config->get('omise_test_mode') ) {
            $keys = array(
                'pkey' => $this->config->get('omise_pkey_test'),
                'skey' => $this->config->get('omise_skey_test')
            );
        } else if ( $this->config->get('omise_paynow_status') || $this->config->get('omise_status') ) {
            $keys = array(
