      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group <?= $event_day_status ? 'required':'hidden' ?>">
            ...
            <div class="col-sm-10">
              <input type="text" name="birthday" value="<?php echo $birthday; ?>" placeholder="<?php echo $entry_birthday; ?>" id="input-birthday" class="form-control birthday" autocomplete="off"/>
