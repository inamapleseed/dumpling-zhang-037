            ...
            <tr>
              ...
              <td class="text-center">
                ...
                <?php if($order['status_id'] == '1'){ ?> 
                    <a href="<?= $order['cancel']; ?>" onclick="return confirm('Please confirm you want to cancel order?')" class="inline-link esc pointer" 
                      data-title="<?= "Cancel"; ?>: <?= $column_order_id; ?> #<?= $order['cancel']; ?>" >
                      <?= "Cancel"; ?>
                    </a>
                <?php } ?>
              </td>
