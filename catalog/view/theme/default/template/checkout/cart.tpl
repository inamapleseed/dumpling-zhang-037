              ...
              <tr>
                ...
                <td class="text-center cart-quantity">
                    ...
                    <div class="input-group" id="cart-item-<?= $product['cart_id']; ?>" >
                      ...
                      <input type="text" name="quantity[<?= $product['cart_id']; ?>]" style="max-width: 100px" class="form-control input-number integer text-center update-cart no-custom" value="<?= $product['quantity']; ?>" onfocus="rememberQuantity('<?= $product['quantity']; ?>');" onblur="refreshCart(this);" >
