<h3 class="nl-h3"><?php echo $feat_title; ?></h3>
  <div class="">
    ...
    <div id="news_latest" class="bnews-list">
		<?php foreach ($article as $articles) { ?>
			<div class="artblock">
				<a href="<?php echo $articles['href']; ?>" class="c-overlay"></a>
				<div class="img_container">
					<img class="article-image" src="<?= $articles['thumb'] ?>"/>
				</div>
				<div class="info">
		<!-- 			<?php if ($articles['name']) { ?>
						<div class="name"><a href="<?php echo $articles['href']; ?>"><?php echo $articles['name']; ?></div>
					<?php } ?> -->
