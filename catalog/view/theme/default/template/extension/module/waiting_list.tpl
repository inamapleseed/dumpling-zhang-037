<div id="waiting_list">
    <div class="waiting_list_container">
        ...
        <div class="flex-group flex-wrap flex-just-cont-center">
            ...
            <button id="waiting_list_submit" type="button" class="btn btn-primary fancy-btn" ><?= $button_submit; ?><img src="image/catalog/slicing/general/button_bg-orange.png" alt="button" class="fancy"></button>
        </div>
    </div>
