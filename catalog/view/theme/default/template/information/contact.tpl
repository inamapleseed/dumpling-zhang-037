			...
			<div class="contact-con">
				<div class="contact-information">
					...
					<div class="inner-contact-info">
						<div>
							...
							<a href="tel:<?php echo $store_telephone; ?>"><?php echo $store_telephone; ?></a><br><br>
							<span><?php echo $entry_email; ?></span><br> 
							<a href="mailto:<?php echo $store_email; ?>"><?php echo $store_email; ?></a><br> <br>
				...
				<form id="contact-us-form" action="<?= $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="contact-body">
						...
						<div class="form-group required">
							<input type="text" name="email" value="<?= $email; ?>" id="input-email" class="form-control" placeholder="<?php echo $entry_email; ?>" />
							<?php if ($error_email) { ?>
						...
						<div class="form-group required">
							<input type="tel" name="telephone" value="<?= $telephone; ?>" id="input-telephone" class="form-control input-number" placeholder="<?php echo $entry_telephone ?>" />
