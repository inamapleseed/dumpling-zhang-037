	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/fcategory', 'token=' . $this->session->data['token'], 'SSL')
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/fcategory', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/fcategory', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/module/fcategory', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		if (isset($this->request->post['cn_name'])) {
			...
			$data['cn_name'] = $module_info['cn_name'];
		} else {
			$data['cn_name'] = '';
		}
		...
		if (isset($this->request->post['cn_custom_description'])) {
			...
			$data['cn_custom_description'] = $module_info['cn_custom_description'];
		} else {
		...
		if (isset($this->request->post['custom_description'])) {
			...
			$data['custom_description'] = $module_info['custom_description'];
		} else {
		...
		if (isset($this->request->post['button_name'])) {
			...
			$data['button_name'] = $module_info['button_name'];
		} else {
			$data['button_name'] = '';
		}
		if (isset($this->request->post['cn_button_name'])) {
			...
			$data['cn_button_name'] = $module_info['cn_button_name'];
		} else {
			$data['cn_button_name'] = '';
		}
		...
		$this->response->setOutput($this->load->view('extension/module/fcategory.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/fcategory')) {
