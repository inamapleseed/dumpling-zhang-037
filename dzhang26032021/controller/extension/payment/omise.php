...
class ControllerExtensionPaymentOmise extends Controller {
    ...
    private function pageDataSettingTab() {
        ...
        return array(
            ...
            'omise_success_status' => $this->config->get('omise_success_status'),
            'omise_process_status' => $this->config->get('omise_process_status'),
            'omise_cancel_status' => $this->config->get('omise_cancel_status'),
    ...
    private function pageTranslation() {
        ...
        return array(
            ...
            'label_instruction'                       => $this->language->get('label_instruction'),
            'label_title_instruction'                 => $this->language->get('label_title_instruction'),
            ...
            'webhook_url'                             => HTTPS_CATALOG . 'index.php?route=extension/payment/omise/webhook',
        );
    }
    ...
    public function index() {
        ...
        $data = array_merge(
            ...
            array(
                ...
                'cancel'             => $this->url->link('extension/extension', 'type=payment&token=' . $this->session->data['token'], 'SSL'),
        ...
        if (isset($this->request->post['omise_sort_order'])) {
            $data['omise_sort_order'] = $this->request->post['omise_sort_order'];
        } else {
            $data['omise_sort_order'] = $this->config->get('omise_sort_order');
        }
