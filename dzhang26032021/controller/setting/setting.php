...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['lalamove_status'])) {
			$data['error_lalamove_status'] = $this->error['lalamove_status'];
		} else {
			$data['error_lalamove_status'] = '';
		}
		
		if (isset($this->error['lalamove_after_status'])) {
			$data['error_lalamove_after_status'] = $this->error['lalamove_after_status'];
		} else {
			$data['error_lalamove_after_status'] = '';
		}
		
		if (isset($this->error['lalamove_cancel_status'])) {
			$data['error_lalamove_cancel_status'] = $this->error['lalamove_cancel_status'];
		} else {
			$data['error_lalamove_cancel_status'] = '';
		}
		...
		if (isset($this->request->post['config_lalamove_status'])) {
			$data['config_lalamove_status'] = $this->request->post['config_lalamove_status'];
		} elseif ($this->config->get('config_lalamove_status')) {
			$data['config_lalamove_status'] = $this->config->get('config_lalamove_status');
		} else {
			$data['config_lalamove_status'] = array();
		}

		if (isset($this->request->post['config_lalamove_after_status'])) {
			$data['config_lalamove_after_status'] = $this->request->post['config_lalamove_after_status'];
		} elseif ($this->config->get('config_lalamove_after_status')) {
			$data['config_lalamove_after_status'] = $this->config->get('config_lalamove_after_status');
		} else {
			$data['config_lalamove_after_status'] = array();
		}

		if (isset($this->request->post['config_lalamove_cancel_status'])) {
			$data['config_lalamove_cancel_status'] = $this->request->post['config_lalamove_cancel_status'];
		} elseif ($this->config->get('config_lalamove_cancel_status')) {
			$data['config_lalamove_cancel_status'] = $this->config->get('config_lalamove_cancel_status');
		} else {
			$data['config_lalamove_cancel_status'] = array();
		}
