     ...
     <div class="pull-right">
      <select class="preview-type form-control" style="width:200px">
       <optgroup label="<?php echo $_language->get('text_type_customer'); ?>">
        ...
        <option value="customer.information.birthday"><?php echo $_language->get('text_type_customer.information.birthday'); ?></option>
        <option value="customer.account.membership"><?php echo $_language->get('text_type_customer.account.membership'); ?></option>
       </optgroup>
       <?php /* ?>
      ...
      <optgroup label="<?php echo $_language->get('text_type_enquirystatus'); ?>">
       ...
       <optgroup label="<?php echo $_language->get('text_type_admin'); ?>">
        <?php 
          ...
          foreach (array('admin.order.confirm', 'admin.order.status', 'admin.enquiry.confirm', 'admin.customer.register', 'admin.information.contact') as $type) { ?>
