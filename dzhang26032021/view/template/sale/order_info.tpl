            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><?php if ($customer && $reward) { ?>
                  <?php if (!$reward_total) { ?>
                  <button id="button-reward-add" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $text_reward_unallocated; ?>" class="btn btn-danger btn-xs"><i class="fa fa-exclamation"></i></button>
                  <?php } else { ?>
                  <button id="button-reward-add" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="<?php echo $text_reward_allocated; ?>" class="btn btn-success btn-xs"><i class="fa fa-check"></i></button>
                  <?php } ?>
                  <?php } else { ?>
                  <button disabled="disabled" class="btn btn-success btn-xs hidden"><i class="fa fa-plus-circle"></i></button>
                  <?php } ?></td>
              </tr>
            </tbody>
          </table>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              <td class="text-left"><?php echo $payment_address; ?><br>Contact No.:<?php echo $telephone; ?></td>
              <?php if ($shipping_method) { ?>
              <td class="text-left"><?php echo $shipping_address; ?><br>Contact No.:<?php echo $telephone; ?></td>
              <?php } ?>
            </tr>
          </tbody>
        </table>
  ...
  $.ajax({
    ...
    success: function(json) {
      ...
      if (json['success']) {
        ...
        $('#button-reward-add').replaceWith('<button id="button-reward-add" data-toggle="tooltip" title="<?php echo $text_reward_allocated; ?>" class="btn btn-success btn-xs"><i class="fa fa-check"></i></button>');
      }
    },
    error: function(xhr, ajaxOptions, thrownError) {
      alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
...
$.ajax({
	...
	success: function(json) {
        ...
        if (json['error']) {
    		if (json['error']['key']) {
    			$('#content > .container-fluid').prepend('<div class="alert alert-danger stick"><i class="fa fa-exclamation-circle"></i> ' + json['error']['key'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
    		}

            if (json['error']['ip']) {
    			$('#content > .container-fluid').prepend('<div class="alert alert-danger stick"><i class="fa fa-exclamation-circle"></i> ' + json['error']['ip'] + ' <button type="button" id="button-ip-add" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger btn-xs pull-right"><i class="fa fa-plus"></i> <?php echo $button_ip_add; ?></button></div>');
    		}
        }
...
$('#button-history').on('click', function() {
  ...
  $.ajax({
    url: 'index.php?route=sale/order/status_change_reward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
    type: 'post',
    dataType: 'json',
