  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" id="button-pickpacklist" form="form-order" formaction="<?php echo $pickpacklist; ?>" formtarget="_blank" data-toggle="tooltip" title="<?php echo $text_pickpacklist; ?>" class="btn btn-warning"><i class="fa fa-truck"></i></button>
